<template>
  <div id="computed">
    ...
    <div class="box">
      ...
      <div class="computeData">
        ...
        <div>
          ...
          <input
            type="number"
            min="1"
            v-model="eventDiscountRate"
            :disabled="!discountMap.event"
          />
        </div>
        <div>
          <label>
          ...
          <input
            type="number"
            min="1"
            v-model="staffDiscountRate"
            :disabled="!discountMap.staff"
          />
        </div>
        <div>
          <span>원가</span>
      ...
      <div class="showData">
        <img
          src="https://www.venturesquare.net/wp-content/uploads/2019/03/hiver.jpg"
        />
